...
export const EXAMPLE_SHEETS = {
  ...
  'Project Board': {
    folder: 'Kanban',
    headers: ['Task', 'Description', 'Stage', 'Project', 'Assignee', 'Priority', 'Due', 'Label', 'Note'],
    rows: [
      ['Design login page',    'Build the auth UI with email/password and OAuth buttons', 'Done',        'Frontend', 'Alice',  'P0', '2026-02-20', 'feature', ''],
      ...
      ['Set up CI pipeline',   'Configure GitHub Actions for lint, test, and deploy',      'In Progress', 'DevOps',   'Bob',    'P1', '2026-03-10', 'infra',   ''],
      ['',                     'Add lint step to workflow',                                'Done',        '',         'Bob',    '',   '2026-03-05', '',        ''],
      ['',                     'Add Playwright test step',                                'In Progress', '',         'Bob',    '',   '2026-03-08', '',        ''],
      ['Write API docs',       'Document all REST endpoints with examples',                'In Progress', 'Backend',  'Carol',  'P2', '2026-03-15', 'docs',    ''],
      ['Add dark mode',        'Implement dark theme using CSS custom properties',         'To Do',       'Frontend', 'Alice',  'P2', '2026-03-20', 'feature', ''],
      ['Fix nav bug',          'Sidebar collapses unexpectedly on mobile viewports',       'Done',        'Frontend', 'Bob',    'P0', '2026-02-25', 'bug',     ''],
      ['Implement search',     'Full-text search across all sheets with highlighting',     'Backlog',     'Frontend', '',       'P1', '',           'feature', ''],
      ['Database migration',   'Migrate user settings from v1 to v2 schema',               'To Do',       'Backend',  'Carol',  'P1', '2026-03-12', 'infra',   ''],
      ['User onboarding flow', 'Interactive tutorial for first-time users',                 'Backlog',     'Frontend', '',       'P2', '',           'feature', ''],
      ['Performance audit',    'Profile and optimize initial load and sheet rendering',     'In Progress', 'Frontend', 'Alice',  'P1', '2026-03-08', 'infra',   ''],
    ],
  },
  ...
  'Product Roadmap': {
    ...
    headers: ['Task', 'Description', 'Stage', 'Project', 'Assignee', 'Priority', 'Due', 'Label', 'Note'],
    rows: [
      ['Multi-language support', 'Add i18n framework and translate all UI strings',         'Backlog',     'Platform',  'Product', 'P2', '',           'feature', ''],
      ['Mobile app v2',          'Complete redesign of the mobile experience',               'In Progress', 'Mobile',    'Mobile',  'P0', '2026-04-01', 'feature', ''],
      ['',                       'Redesign navigation for thumb-friendly use',               'Done',        '',          'Mobile',  '',   '2026-03-10', '',        ''],
      ['',                       'Implement offline sync',                                   'In Progress', '',          'Mobile',  '',   '2026-03-25', '',        ''],
      ['Analytics dashboard',    'Build real-time usage analytics with charts',              'To Do',       'Data',      'Data',    'P1', '2026-03-30', 'feature', ''],
      ['SSO integration',        'Support SAML and OIDC for enterprise customers',          'Done',        'Platform',  'Backend', 'P1', '2026-02-15', 'infra',   ''],
      ['Notification system',    'Email and in-app notifications for sheet changes',        'In Progress', 'Platform',  'Backend', 'P2', '2026-03-20', 'feature', ''],
      ['Dark theme',             'System-preference-aware dark mode toggle',                'To Do',       'Frontend',  'Frontend','P3', '2026-04-15', 'design',  ''],
    ],
  },
